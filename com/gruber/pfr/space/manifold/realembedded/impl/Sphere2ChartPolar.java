...
public class Sphere2ChartPolar implements RnEmbeddedChart {
	...
	public Set getPreImage(RealVector vec) {
		...
		float x = new Double(Math.sin(vec.getElements()[0].getBase())).floatValue()
				* new Double(Math.cos(vec.getElements()[1].getBase())).floatValue();

		float y = new Double(Math.sin(vec.getElements()[1].getBase())).floatValue();

		float z = new Double(Math.cos(vec.getElements()[0].getBase())).floatValue()
				* new Double(Math.cos(vec.getElements()[1].getBase())).floatValue();
