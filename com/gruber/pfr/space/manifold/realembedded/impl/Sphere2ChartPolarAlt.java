...
public class Sphere2ChartPolarAlt implements RnEmbeddedChart {
...
//			phi = 0;
//		else 
		if (vec.getElements()[1].getBase() == 0 && vec.getElements()[2].getBase() < 0)
			phi = new Double(Math.PI * 3 / 2).floatValue();
		else if (vec.getElements()[1].getBase() == 0 && vec.getElements()[2].getBase() > 0)
			phi = new Double(Math.PI / 2).floatValue();
		else
			phi = new Double(Math.atan(vec.getElements()[2].getBase() / vec.getElements()[1].getBase())).floatValue();

		if(phi < 0)
			phi += Math.PI * 2;
		
		float psi = new Double(Math.asin(vec.getElements()[0].getBase())).floatValue();
	...
	public Set getPreImage(RealVector vec) {
		...
		float y = new Double(Math.sin(vec.getElements()[0].getBase())).floatValue()
				* new Double(Math.cos(vec.getElements()[1].getBase())).floatValue();

		float z = new Double(Math.sin(vec.getElements()[1].getBase())).floatValue();

		float x = new Double(Math.cos(vec.getElements()[0].getBase())).floatValue()
				* new Double(Math.cos(vec.getElements()[1].getBase())).floatValue();
...
//			return false;
		...
		return !vec.getElements()[2].equals(nullEl) || vec.getElements()[0].greaterThen(nullEl);
	}
